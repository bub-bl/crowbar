...
/// (<c>Shaders/Surface/StandardPbr.slang</c>, <c>Game/DemoComponent.cs</c> ... the game
...
public sealed class FileSystemService
{
    ...
    /// <summary>Opens (or creates) a file for writing, overwriting the existing content.</summary>
